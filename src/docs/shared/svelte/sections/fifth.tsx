const SvelteDocFifthSection = () => (
  <section className="mb-12">
    ...
    <p className="mt-5">
      ...
      <strong className="px-1">dashboard/sidenavigation/Index.svelte</strong>
      file
    </p>
    <p className="mt-5">
      In the <strong> dashboard/Layout.svelte</strong> file,
      <strong className="pl-1">Sidenavigation</strong> component has a prop
...
export default SvelteDocFifthSection;
