const SvelteDocFourthSection = () => (
  <section className="mb-12">
    ...
    <p className="mt-4">
      ...
      <span className="px-1 font-semibold">tailwind.config.cjs</span>and paste
      it into your
      <span className="px-1 font-semibold">tailwind.config.cjs</span>
...
export default SvelteDocFourthSection;
