const SharedReactNextFifthSection = () => (
  <section className="mb-12">
    ...
    <p className="mt-5">
      The sidenav scrollbar is hidden by default but you can èvvstill scroll
      with the keyboards if you have several sidenav-items. If you are not a fan
      of this approach, you can always change its style in the
...
export default SharedReactNextFifthSection;
