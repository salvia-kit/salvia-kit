    ...
    <div className="mb-8">
      ...
      <div className="flex flex-wrap mt-6 pl-6 md:flex-nowrap">
        ...
        <p className="pl-1">
          ...
          contains the
          <span className="pl-1 font-semibold"> sidenav-item</span> component
        </p>
      </div>
        ...
        {section && version !== 8 && (
          <>
            ...
            <ul className="pt-8 lg:pl-4 lg:pt-0 lg:w-6/12">
              ...
              <li className="mb-2">
                <span className="px-1 font-semibold">to :</span> name of the
                route
              </li>
              <li className="mb-2">
                <span className="px-1 font-semibold">sidenav-item slot :</span>{' '}
                the icon, imported from
        ...
        {section && version === 8 && (
          <>
            ...
            <ul className="pt-8 md:pl-4 md:pt-4 md:w-6/12">
              <li className="mb-2">
                <strong className="px-1">template #item :</strong> contains the
                name of the section
              </li>
              <li className="mb-2">
                <strong className="px-1">template #panel :</strong> content of
                the accordion (sidenav-item)
              </li>
...
export default SharedNuxtVueSecondSection;
