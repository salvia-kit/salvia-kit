...
import { VueSnippet, VueSnippetShort } from '@/src/docs/common/snippets';

const VueCommonSecondSectionV1AndV7 = () => (
  <section className="mb-12">
    ...
    <div className="mb-8">
      ...
      <div className="flex flex-wrap mt-6 pl-6 md:flex-nowrap">
        ...
        <p className="pl-1">
          Contains the
          <span className="font-semibold"> sidenav-items-section</span>{' '}
      ...
      <div className="flex flex-wrap mt-6 pl-6 md:flex-nowrap">
        ...
        <p className="pl-1">
          ...
          <span className="font-semibold"> sidenav-item</span> components
        </p>
      </div>
      <div className="flex flex-wrap mb-12 mt-8 pl-8">
        ...
        <ul className="pt-8 lg:pl-4 lg:pt-0 lg:w-6/12">
          ...
          <li className="mb-2">
            <strong className="px-1">name :</strong> name of the section
          </li>
          <li className="mb-2">
            <strong className="px-1 font-semibold">title :</strong> text that
            indicate the route
          </li>
          <li className="mb-2">
            <strong className="px-1 font-semibold">to :</strong> name of the
            route
          </li>
          <li className="mb-2">
            <strong className="px-1 font-semibold">sidenav-item slot :</strong>{' '}
            the icon, imported from <strong className="px-1">icons</strong>{' '}
            folder or from your library
          </li>
        </ul>
      </div>
      <div className="flex flex-wrap mt-6 pl-6 md:flex-nowrap">
...
const VueCommonSecondSectionV3AndV4AndV6 = () => (
  <section className="mb-12">
    <h2 className="text-2xl font-medium">File Structure explained</h2>
    <p className="mt-5">
      We will focus on <span className="font-semibold">dashboard</span> folder
...
export { VueCommonSecondSectionV1AndV7, VueCommonSecondSectionV3AndV4AndV6 };
