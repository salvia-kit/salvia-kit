    ...
    <div className="mt-8">
      <ul className="mt-4 pl-6 list-disc">
        ...
        <li className="mb-3">
          ...
          <span className="px-1 font-semibold">DashboardLayout</span> imported
          from
          <span className="px-1 font-semibold">dashboard/layout.js</span>
        </li>
      </ul>
    </div>
  </section>
...
export default V7NextFourthSection;
