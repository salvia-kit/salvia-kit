import { ReactSnippetShort } from '@/src/docs/common-sections/snippets';
import { FileIcon, FolderIcon, JsIcon } from '@/src/components/icons/icons';

const ReactCommonSecondSection = ({ snippet }: { snippet?: any }) => (
...
export default ReactCommonSecondSection;
